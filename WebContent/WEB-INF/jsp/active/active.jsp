...
<body>
	...
	<div id="tb" style="padding: 10px 5px 5px 10px; height: auto;">
		...
		<div style="margin-bottom: 5px;margin-top: 5px;">
			&nbsp;&nbsp;&nbsp;
			<a href="#" class="easyui-linkbutton" iconCls="icon-add" plain="false" onclick="addAdActivityDiv()">添加活动</a>&nbsp;&nbsp; 
			&nbsp;&nbsp;&nbsp;
			<a href="#" class="easyui-linkbutton" iconCls="icon-edit" plain="false" onclick="editActivityDiv()">编辑活动</a>&nbsp;&nbsp;
			&nbsp;&nbsp;&nbsp;
			<a href="#" class="easyui-linkbutton" iconCls="icon-remove" plain="false" onclick="deleteActivity()">删除活动</a>&nbsp;&nbsp;
			&nbsp;&nbsp;&nbsp;
...
<script type="text/javascript" src="${ctxPath}/jspage/active/active.js"></script>
