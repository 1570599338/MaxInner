				    ...
				    <table class="content"   border="1" bordercolor="#cccccc" style="border-collapse:collapse;">
					       <thead>
						      <tr bgcolor="#0081c2">
						        ...
						        <td width="170">会议室1</td>
						        <td width="170">会议室2</td>
						        <td width="170">会议室3</td>
						        <td width="170">会议室4</td>
						       </tr>
					       </thead>
				...
				<tr>
					...
					<td style="text-align: right" nowrap="nowrap">
						<select class="easyui-combobox"  panelHeight="auto" style="width: 180px" id="meet" name="meet" >
                                    ...
                                    <option value="21">会议室1</option>
                                    <option value="22">会议室2</option>
                                    <option value="23">会议室3</option>
                                    <option value="24">会议室4</option>
