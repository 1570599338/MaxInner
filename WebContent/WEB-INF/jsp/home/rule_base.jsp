...
<script type="text/javascript" src="${ctxPath}/jspage/home/rule_base.js"></script>
<style type="text/css">
	#copyright_rule{
	position:relative;
	margin:0 auto 0;
...
<div class="wrapper col2">	
	<div id="detail">    	  
    	  <div class="detail_content clear">
            <p><a href="${ctxPath}/home/toHome">首页</a>&nbsp;&gt;&nbsp;<a href="${ctxPath}/home/toHome#rules">规章制度</a>&nbsp;&gt;&nbsp;</p>
            <!--  -->
            <form action="" method="post" id="dataForm" name="dataForm" target="_blank">
			...
			<div id="tb" style="padding: 10px 5px 5px 10px; height: auto;">
				...
				<%-- 	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<a href="#" class="easyui-linkbutton" iconCls="icon-add" plain="false" onclick="viewPdf('${ctxPath}')">查看</a>&nbsp;&nbsp;  --%>
				</div>
			</div>
			<!--数据显示 --Start -->
