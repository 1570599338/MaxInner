...
<body>
	...
	<div id="tb" style="padding: 10px 5px 5px 10px; height: auto;">
		<div>&nbsp;&nbsp;&nbsp;
			文&nbsp;件&nbsp;名 ：<input class="input_text" type="text" style="width: 150px" id="log_title" name="log_title" />&nbsp;&nbsp;&nbsp; 
			&nbsp;&nbsp;&nbsp;
		...
		<div style="margin-bottom: 5px;margin-top: 5px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<a href="#" class="easyui-linkbutton" iconCls="icon-add" plain="false" onclick="updateAdDiv()">上传规章制度</a>&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;
	...
	<form id="upfileForm" name="upfileForm" method="post"  enctype="multipart/form-data" action="<%=ctxPath%>/rule/uploadFile">
			...
			<table border="0"  style="text-align: left;">
				<tr>
					...
					<td style="text-align: right" nowrap="nowrap">
						<select class="easyui-combobox"  panelHeight="auto" style="width: 100px" id="upfileType" name="upfileType" >
                                    ...
                                    <option value="1">基本制度</option>
                                    <option value="2">IT制度</option>
                                    <option value="3">财务制度</option>
                       </select>
					</td>
				...
				<tr>
					<td colspan="4" style="padding-left:260px;">
